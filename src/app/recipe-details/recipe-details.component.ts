...
// }
  constructor(private router: Router, private activatedRoute: ActivatedRoute ,private homeRecipeService:HomeRecipeService ,private sanitizer: DomSanitizer) {}
  ngOnInit(): void {
...
sanitizeHtml(html: string): string {
  ...
  sanitizeAndTrim(instruction: string): SafeHtml {
    return this.sanitizer.bypassSecurityTrustHtml(instruction.trim());
  }
